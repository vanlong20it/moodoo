    ...
    <div className="max-w-2xl w-full grid grid-cols-1 md:grid-cols-2 gap-6">
      ...
      <div className="bg-white rounded-3xl shadow-xl overflow-hidden flex flex-col">
        <div className="p-6 bg-indigo-600 text-white">
            ...
            <p className="text-indigo-200 text-sm mt-1">Mô phỏng quét mã QR tại các trạm</p>
        </div>
            ...
            {QR_CONTEXTS.map(ctx => (
                ...
                >
                    ...
                    <div className="text-left">
                        <span className="block font-bold text-slate-700 text-sm">{ctx.title}</span>
                        <span className="text-[10px] uppercase font-bold text-slate-400">{ctx.category}</span>
                    </div>
                </Link>
            ))}
        </div>
      ...
      <div className="bg-white rounded-3xl shadow-xl overflow-hidden flex flex-col">
         <div className="p-6 bg-emerald-600 text-white">
            ...
            <p className="text-emerald-200 text-sm mt-1">Theo dõi và phân tích dữ liệu</p>
        </div>
        <div className="p-6 flex-1 flex flex-col justify-center items-center text-center space-y-6">
            ...
            <div>
                <h3 className="text-lg font-bold text-gray-800 mb-2">Dashboard Quản Lý</h3>
                <p className="text-gray-500 text-sm mb-6">Xem thống kê cảm xúc của trẻ và nhận gợi ý từ AI chuyên gia.</p>
                <Link 
                    to="/dashboard"
